...
<head>
    ...
    <title>{{ __('Add New Grade') }}</title> {{-- Translate title --}}
...
<body class="bg-gray-100 p-6"> {{-- Applied Tailwind background and padding to body --}}
    ...
    @section('content')
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 py-6">
            ...
            {{-- Page Title --}}
            <h2 class="text-2xl font-bold mb-6 text-gray-800">{{ __('Add New Grade') }}</h2> {{-- Translate title --}}
            ...
            {{-- Grade Creation Form --}}
            {{-- Assuming grade creation is handled by a standard controller action --}}
            <form action="{{ route('admin.grades.store') }}" method="POST">
                ...
                <div class="border border-gray-300 rounded-lg p-6 mb-6 bg-white shadow-md">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="code" id="code"
                            ...
                            {{-- Added Tailwind validation styling --}} required value="{{ old('code') }}"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" id="description" rows="3"
                            ...
                            {{-- Added Tailwind validation styling --}} placeholder="{{ __('Enter grade description') }}">{{ old('description') }}</textarea> {{-- Added placeholder --}}
                        @error('description')
                            {{-- Replaced custom text-danger span with Tailwind class --}}
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="mb-4">
                        <div class="flex items-center"> {{-- Use flex for checkbox and label alignment --}}
                            <input type="checkbox" name="requires_approval" id="requires_approval" value="1"
                                ...
                                {{-- Used Tailwind classes for checkbox --}} {{ old('requires_approval') ? 'checked' : '' }}>
                ...
                <div class="flex justify-center mt-6">
                    ...
                    <button type="submit"
                        ...
                        {{ __('Save Grade') }} {{-- Translate string --}}
                    </button>
                </div>
