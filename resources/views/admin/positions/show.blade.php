    ...
    @section('content')
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 py-8"> {{-- Container for the content --}}
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6"> {{-- Card-like container --}}
                ...
                <h2 class="text-2xl font-bold mb-6 text-gray-800">Butiran Jawatan: {{ $position->name ?? 'N/A' }}</h2>
                ...
                {{-- Position Details --}}
                <div class="card">
                    <h3 class="card-title">Butiran Jawatan</h3>

                    <p class="mb-2"><span class="font-semibold">Nama Jawatan:</span> {{ $position->name ?? 'N/A' }}</p>
                    <p class="mb-2"><span class="font-semibold">Kod Jawatan:</span> {{ $position->code ?? 'N/A' }}</p>
                    <p class="mb-2"><span class="font-semibold">Penerangan:</span> {{ $position->description ?? '-' }}</p>
                </div> {{-- End card --}}
