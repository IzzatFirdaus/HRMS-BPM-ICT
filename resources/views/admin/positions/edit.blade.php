...
<body class="bg-gray-100 p-6">
    ...
    @section('content')
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 py-6"> {{-- Container for the content --}}
            ...
            <h2 class="text-2xl font-bold mb-6 text-gray-800">Edit Jawatan: {{ $position->name ?? 'N/A' }}</h2>
            {{-- Title with position name --}}
            ...
            <form action="{{ route('admin.positions.update', $position) }}" method="POST">
                ...
                <div class="card">
                    <h4 class="card-title">Butiran Jawatan</h4>

                    <div class="form-group">
                        <label for="name" class="block text-gray-700 text-sm font-bold mb-2">Nama Jawatan*:</label>
                    ...
                    <div class="form-group">
                        <label for="code" class="block text-gray-700 text-sm font-bold mb-2">Kod Jawatan:</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" class="form-control" rows="3">{{ old('description', $position->description) }}</textarea> {{-- Populate with existing data --}}
                        @error('description')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
