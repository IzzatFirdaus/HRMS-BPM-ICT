{{--
    ...
    ****************************************************************************
    IMPORTANT: This view critically relies on eager loading of the 'user' relationship
               ...
               method that renders this view to avoid N+1 query issues.
               Example in controller: Employee::with([
                   'user.department', 'user.position', 'user.grade',
                   'leaves.leaveType', // Assuming Leave has leaveType relationship
                   'fingerprints.device', // Assuming Fingerprint has device relationship
                   'user.emailApplications', 'user.loanApplications',
...
@section('title', __('Employee Profile: :name', ['name' => $employee->full_name ?? 'N/A']))

{{-- Define any page-specific styles (optional) --}}
@section('page-style')
    {{-- Link any CSS specific to this page if needed, typically compiled assets --}}
    {{-- Example: <link rel="stylesheet" href="{{ asset('css/employees-profile-show.css') }}"> --}}
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-wrap items-center justify-between mb-6 gap-4"> {{-- Added flex-wrap and gap for better responsiveness --}}
            ...
            <h1 class="text-2xl font-bold text-gray-800">
                {{ __('Employee Profile') }}: {{ $employee->full_name ?? 'N/A' }} {{-- Using the employee's full name accessor, provide fallback --}}
            </h1>
